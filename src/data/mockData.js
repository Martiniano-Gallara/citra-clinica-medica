...
export const INITIAL_CLINIC_INFO = {
  ...
  logo: '/citra-logo.png',
  cuit: '30-71829340-8',
  address: 'Av. Carlos Pontin Nº556, Arroyito, Córdoba',
  mapsUrl: 'https://maps.app.goo.gl/FJhLndjvgSAWb2Si6',
  postalCode: '2434',
  addressFull: 'Av. Carlos Pontin Nº556, Arroyito, Córdoba (CP 2434)',
  ...
  branches: [
    {
      ...
      address: 'Av. Carlos Pontin Nº556, Arroyito, Córdoba (CP 2434)',
...
export const INITIAL_SPECIALTIES = [
  ...
  { id: 'esp-5', name: 'Kinesiología', icon: 'Dumbbell', defaultDuration: 40, estimatedDuration: 40, color: '#076ABC', category: 'Rehabilitación', description: 'Recuperación funcional activa, pre y post-quirúrgica en gimnasio terapéutico.' },
  { id: 'esp-6', name: 'Fisioterapia', icon: 'Zap', defaultDuration: 40, estimatedDuration: 40, color: '#257CE6', category: 'Rehabilitación', description: 'Magnetoterapia, ultrasonido, electroestimulación y analgesia profunda.' },
...
export const INITIAL_DOCTORS = [
  {
    ...
    bio: 'Especialista en traumatología y ortopedia, patología de rodilla, hombro y lesiones deportivas de alta competencia.',
  ...
  },
  {
    ...
    workingDays: ['Martes', 'Jueves', 'Sábados'],
    scheduleStart: '09:00',
    scheduleEnd: '15:00',
    slotDuration: 30,
    priceConsultation: 25000,
    ...
    bio: 'Cirujano ortopedista enfocado en miembro inferior, cadera, columna y tratamientos de restitución articular mínimamente invasivos.',
  ...
  },
  {
    ...
    specialtyId: 'esp-12',
    specialtyName: 'Ozonoterapia & Medicina Regenerativa',
    specialtyIds: ['esp-12'],
    ...
    workingDays: ['Lunes', 'Miércoles', 'Jueves'],
    scheduleStart: '14:00',
    scheduleEnd: '19:00',
    slotDuration: 30,
    ...
    bio: 'Médico especialista en ozonoterapia médica para artrosis severa, dolor raquídeo, discopatías, fibromialgia y regeneración tisular biológica.',
  ...
  },
  {
    ...
    bio: 'Rehabilitación activa pre y post quirúrgica, terapia manual ortopédica y readaptación biomecánica funcional.',
  ...
  },
  {
    ...
    specialtyId: 'esp-5',
    specialtyName: 'Kinesiología & Osteopatía Biomecánica',
    ...
    bio: 'Kinesiólogo y Osteópata especializado en terapia manual estructural, craneosacral y cadenas miofasciales para resolver dolores mecánicos de raíz.',
  ...
  },
  {
    ...
    specialty: 'Kinesiología, Suelo Pélvico & ATM',
    specialtyId: 'esp-5',
    ...
    phone: '3576 450214',
    roomId: 'room-201',
    roomName: 'Consultorio 201 — Piso Pélvico & ATM',
    color: '#257CE6',
    ...
    workingDays: ['Martes', 'Jueves', 'Viernes'],
    scheduleStart: '09:00',
    scheduleEnd: '17:00',
    slotDuration: 40,
    ...
    bio: 'Especialista en rehabilitación uroginecológica de suelo pélvico (postparto, incontinencia) y disfunciones de articulación temporomandibular (ATM y bruxismo).',
  ...
  },
  {
    ...
    phone: '3576 450214',
    roomId: 'room-203',
    roomName: 'Consultorio 203 — Medicina Estética',
    color: '#076ABC',
  ...
  },
  {
    ...
    specialty: 'Nutrición',
    specialtyId: 'esp-4',
    specialtyName: 'Nutrición Clínica & Deportiva',
    specialtyIds: ['esp-4'],
    ...
    workingDays: ['Lunes', 'Martes', 'Miércoles'],
    scheduleStart: '14:00',
    scheduleEnd: '18:30',
    slotDuration: 30,
    ...
    bio: 'Nutrición clínica personalizada, planes para patologías metabólicas, recomposición corporal y rendimiento físico deportivo.',
  ...
  },
  {
    ...
    specialtyId: 'esp-11',
    specialtyName: 'Estudio de Pisadas & Baropodometría',
    specialtyIds: ['esp-11'],
    license: 'MP 43.512',
    ...
    active: true,
    experience: '12+ años de experiencia',
    bio: 'Análisis estático y dinámico de la pisada en plataforma baropodométrica computarizada. Confección de plantillas ortopédicas personalizadas.',
  ...
  },
  {
    ...
    specialtyId: 'esp-3',
    specialtyName: 'Reumatología Clínica',
    specialtyIds: ['esp-3'],
    ...
    bio: 'Diagnóstico y tratamiento de artritis reumatoidea, artrosis, espondilitis, lupus y patologías autoinmunes musculoesqueléticas.',
  ...
  },
  {
    ...
    specialtyId: 'esp-2',
    specialtyName: 'Neurología Clínica',
    specialtyIds: ['esp-2'],
    ...
    bio: 'Atención clínica neurológica de cefaleas crónicas, migrañas, neuropatías periféricas, temblores y trastornos del sistema nervioso central.',
  ...
  },
  {
    ...
    specialtyId: 'esp-10',
    specialtyName: 'Radiología Digital Directa',
    specialtyIds: ['esp-10'],
    license: 'MP 12.890 (Bioimágenes)',
    sisaRefeps: 'REFEPS-MP-12890',
    digitalSignatureStatus: 'En Habilitación',
    ...
    scheduleStart: 'Próximamente',
    scheduleEnd: 'Próximamente',
    slotDuration: 20,
    ...
    bio: 'Próxima incorporación del servicio de radiología digital directa de alta definición con entrega instantánea de estudios digitales.',
    stats: { patientsAttended: 0, occupationRate: 100, rating: 5.0 }
  }
];
