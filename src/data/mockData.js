...
export const INITIAL_DOCTORS = [
  ...
  },
  {
    ...
    scheduleDisplay: 'Consultar fechas en secretaría vía WhatsApp',
    workingDays: ['Consultar fechas en secretaría vía WhatsApp'],
    scheduleStart: '09:00',
    scheduleEnd: '18:00',
    slotDuration: 30,
  ...
  },
  {
    ...
    scheduleDisplay: 'Kinesiología: Lunes a viernes 8:00 a 14:00 hs (ATM y Suelo Pélvico: coordinar en CITRA)',
    workingDays: ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'],
    scheduleStart: '08:00',
    scheduleEnd: '14:00',
    slotDuration: 40,
  ...
  },
  {
    ...
    scheduleDisplay: 'Kinesiología: Lunes a viernes 14:00 a 20:30 hs (Osteopatía: coordinar en CITRA)',
    workingDays: ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'],
    scheduleStart: '14:00',
    scheduleEnd: '20:30',
    slotDuration: 45,
  ...
  },
  {
    ...
    specialty: 'Medicina Estética y Atención PAMI',
    specialtyId: 'esp-13',
    specialtyName: 'Medicina Estética y Reparadora · Atención PAMI',
    specialtyIds: ['esp-13'],
    ...
    scheduleDisplay: 'Atención PAMI: Martes y jueves (mañana) · Estética: Lunes, miércoles y viernes',
    workingDays: ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'],
    scheduleStart: '08:30',
    scheduleEnd: '14:00',
    slotDuration: 30,
    ...
    bio: 'Atención integral PAMI y procedimientos de medicina estética y reparadora.',
  ...
  },
  {
    ...
    scheduleDisplay: 'Lunes a viernes (Consultar horarios en secretaría vía WhatsApp)',
    workingDays: ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'],
    scheduleStart: '08:00',
    scheduleEnd: '18:00',
    slotDuration: 20,
  ...
  },
  {
    ...
    scheduleDisplay: 'Lunes y martes (Adultos mayores: martes 10:00 hs)',
...
export const INITIAL_USERS = [
  {
    id: 'usr-1',
    name: 'Dr. Blanco Francisco',
    email: 'dr.blanco@citra.com.ar',
    role: 'Traumatología y Ortopedia',
    adminType: 'doctor',
    doctorId: 'doc-1',
  ...
  {
    id: 'usr-lagos',
    name: 'Dr. Lagos Juan Manuel',
    email: 'dr.lagos@citra.com.ar',
    role: 'Traumatología de Mano',
    adminType: 'doctor',
    doctorId: 'doc-2',
    specialty: 'Traumatología de Mano',
  ...
  {
    id: 'usr-4',
    name: 'Lic. Barrea Gastón',
    email: 'lic.barrea@citra.com.ar',
    role: 'Kinesiología y Fisioterapia',
    adminType: 'doctor',
    doctorId: 'doc-4',
  ...
  {
    id: 'usr-allione',
    name: 'Dra. Allione Macarena',
    email: 'dra.allione@citra.com.ar',
    role: 'Dermatología / Med. Estética',
    adminType: 'doctor',
    doctorId: 'doc-7',
    specialty: 'Dermatología / Med. Estética',
  ...
  {
    id: 'usr-salvagno',
    name: 'Lic. Salvagno Antonella',
    email: 'lic.salvagno@citra.com.ar',
    role: 'Fonoaudiología / Estudio de la Pisada',
    adminType: 'doctor',
    doctorId: 'doc-9',
    specialty: 'Fonoaudiología / Estudio de la Pisada',
  ...
  {
    id: 'usr-miretti',
    name: 'Dra. Miretti Natalia',
    email: 'dra.miretti@citra.com.ar',
    role: 'Pediatría / Reumatología',
    adminType: 'doctor',
    doctorId: 'doc-10',
    specialty: 'Pediatría / Reumatología',
  ...
  {
    id: 'usr-ferreira',
    name: 'Dra. Ferreira Gabriela',
    email: 'dra.ferreira@citra.com.ar',
    role: 'Cirugía General y Flebología',
    adminType: 'doctor',
    doctorId: 'doc-11',
    specialty: 'Cirugía General y Flebología',
  ...
  },
  {
    ...
    name: 'Lic. Emilio',
    email: 'lic.emilio@citra.com.ar',
    role: 'Cirugía de Pie y Miembro Inferior',
    adminType: 'doctor',
    doctorId: 'doc-12',
    specialty: 'Cirugía de Pie y Miembro Inferior',
  ...
  },
  {
    ...
    name: 'Profe Maru',
    email: 'profe.maru@citra.com.ar',
    role: 'Gimnasio Terapéutico / Shama Yoga',
    adminType: 'doctor',
    doctorId: 'doc-13',
    specialty: 'Gimnasio Terapéutico / Shama Yoga',
    sisaLicense: '-',
    mfaEnabled: true,
    status: 'Activo',
  ...
  },
  {
    ...
    title: 'Recepción Centralizada (Asignación de turnos a todos los médicos)',
